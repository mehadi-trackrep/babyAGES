...
export async function generateMetadata({ 
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://your-domain.com/product/${product.category?.toLowerCase().replace(/\s+/g, '-')}/${product.name.toLowerCase().replace(/\s+/g, '-').replace(/[^\w-]/g, '')}-${product.id}`,
      images: [
        {
    ...
    alternates: {
      canonical: `https://your-domain.com/product/${product.category?.toLowerCase().replace(/\s+/g, '-')}/${product.name.toLowerCase().replace(/\s+/g, '-').replace(/[^\w-]/g, '')}-${product.id}`,
    },
  };
}
